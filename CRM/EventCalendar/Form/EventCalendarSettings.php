...
class CRM_EventCalendar_Form_EventCalendarSettings extends CRM_Core_Form {
  ...
  public function postProcess() {
    ...
    if ($submitted['action'] == 'add') {
      $sql = "INSERT INTO civicrm_event_calendar(calendar_title, show_past_events, show_end_date, show_public_events, events_by_month, event_timings, events_from_month, event_type_filters, , time_format_24_hour, recurring_event, enrollment_status)
